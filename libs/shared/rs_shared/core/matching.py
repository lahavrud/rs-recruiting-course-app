...
async def embed_job_task(job_id: int) -> None:
    ...
    """
    from rs_shared.core.services.cv_extraction import job_embedding_text
    from rs_shared.core.services.embeddings import get_embedding_provider
...
async def match_candidate_task(candidate_id: int) -> None:
    ...
    ``.doc``).
    """
    from rs_shared.core.services.cv_extraction import extract_text
    from rs_shared.core.services.embeddings import get_embedding_provider
    from rs_shared.core.services.generation import get_generation_provider
